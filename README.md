...
The _docker-compose.yml_ file already contains the entire "infrastructure". The purpose of this README is to adapt the content of the article to the current versions of the applications and possibly add some informative details where necessary.
